...
##### 功能模式
1.  上电初始页面：K2键选择对应的工作模式和设置  K1键选择进入或退出
2.  自动点焊模式：自动检测到焊件就位 自动执行预设点焊参数流程  
3.  手动点焊模式：K2键选择对应的设置参数名 K3键调整参数
4.  参数设置模式：高温锡膏回流焊模式  开关键进入后设置键控制开启或关闭
5.  充电设置模式：开关键进入后 设置键控制开启或关闭 加减键调节需要恒定的温度
